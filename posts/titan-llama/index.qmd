...
::: {.callout-warning}
This work was submitted as our final project for Deep Learning at MIT (6.7960).
:::
...
**3. This Can be Made Practical.** A naïve implementation of these per-token weight updates is inherently sequential. But with a few tricks, you can actually vectorize much of the computation.
